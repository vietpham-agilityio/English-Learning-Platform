...
export function DeleteQuestionModal({
  ...
  return (
    <ModalShell
      ...
      isBusy={deleting}
      titleId="delete-question-modal-title"
      title="Delete question?"
      description="This cannot be undone. Learners will no longer see this question in their exercises."
      describedById="delete-question-modal-desc"
